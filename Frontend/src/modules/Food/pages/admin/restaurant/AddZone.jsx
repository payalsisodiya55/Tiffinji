...
export default function AddZone() {
  ...
  const loadGoogleMaps = async () => {
    try {
      ...
      // Check if already loaded by another page
  ...
  // --- Render helpers for manual drawing ---
  ...
  // Editable polygon with path sync listeners, NO circle markers on top
  ...
  const initializeMap = (google) => {
    ...
    // Map click listener for manual polygon drawing
  ...
  const drawExistingPolygon = (google, map, coords) => {
    ...
    // Reuse drawEditablePolygon — creates editable polygon with path sync, no blocking markers
    drawEditablePolygon(google, map, validCoords)
    debugLog("drawExistingPolygon: Polygon created successfully")
  }
